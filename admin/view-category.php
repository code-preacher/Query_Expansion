     ...
     if (isset($_GET['id'])) {
       $crud->delete($_GET['id'],'category','view-category.php');
     }
                           ...
                           foreach($qt as $dy){
                            ...
                            <tr>
                             ...
                             <td><?php echo ucfirst($dy['name']); ?></td>
                              <td><?php echo ucfirst($dy['date']); ?></td>
                             <td><a href="view-category.php?id=<?php echo $dy['id']; ?>" ><i class="fa fa-trash text-danger"></i></a></td>
                            </tr>
                            <?php
                          }

                        } else {
                          echo "<tr><td colspan='4'><center>No Category at the moment</center</td></tr>";
                        }
                        ?>
                      </tbody>
                    </table>
